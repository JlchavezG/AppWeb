<!-- Modal -->
<div class="modal fade" data-bs-backdrop="static" id="AvisoPrivacidad" tabindex="-1" aria-labelledby="AvisoPrivacidadLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Nuestro Aviso de Privacidad</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p style="text-align: justify;">En MindCare, tu privacidad y la protección de tus datos personales son nuestra prioridad. Este aviso de privacidad tiene 
                como objetivo informarte sobre el tratamiento que se dará a tus datos personales al utilizar nuestra plataforma.</p>
                <p style="text-align: justify;">1. Responsable del Tratamiento de Datos Personales MindCare, con domicilio en [especificar dirección o medio de contacto], 
                es responsable de la recopilación, uso, almacenamiento y protección de los datos personales que nos proporcionas a través de nuestra plataforma web.</p>
                <p style="text-align: justify;">2. Datos Personales Recopilados Para poder brindarte nuestros servicios de psicología y canalización psicológica, recopilamos 
                los siguientes datos personales:</p>
                <ul>
